...
public class Placement {
	...
	static void up(Puzzle puzzle, ArrayList<Puzzle> res, int zeroCoordinate) {
	...
	static void down(Puzzle puzzle, ArrayList<Puzzle> res, int zeroCoordinate) {
		Puzzle tmp = puzzle.clone();
		tmp.setPrev(puzzle);
		tmp.getBoard().set(zeroCoordinate, puzzle.getBoard().get(zeroCoordinate + puzzle.getEdge()));
		tmp.getBoard().set(zeroCoordinate + puzzle.getEdge(), 0);
	...
	static void left(Puzzle puzzle, ArrayList<Puzzle> res, int zeroCoordinate) {
		Puzzle tmp = puzzle.clone();
		tmp.setPrev(puzzle);
	...
	static void right(Puzzle puzzle, ArrayList<Puzzle> res, int zeroCoordinate) {
		Puzzle tmp = puzzle.clone();
		tmp.setPrev(puzzle);
